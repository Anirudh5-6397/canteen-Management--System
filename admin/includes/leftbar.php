	<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li class="ts-label" style="color:#FF957E">Main</li>
            ...
            <li><a href="menu.php"><i class="fa fa-user"></i>&nbsp;Menu</a>
			</li>
            <li><a href="order1.php"><i class="fa fa-user"></i>&nbsp;Order Log</a>
			</li>
            <li><a href="mu2.php"><i class="fa fa-briefcase"></i>&nbsp;Categories</a>
			</li>
            <li><a href="prodlist.php"><i class="fa fa-envelope"></i>&nbsp;Products</a>
			</li>
			...
			<p class="text-center" style="color:#ffffff; margin-top: 100px;">© Parth Maniar</p>
		</nav>
