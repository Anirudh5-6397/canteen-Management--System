...
if(isset($_POST['submit']))
  {
	...
	$sql="UPDATE categories SET name=(:name) WHERE id=(:editid)";
    ...
    $sql1="UPDATE items SET cname=(:name) WHERE cid=(:editid)";
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">Edit Category <?php echo htmlentities($result->name); ?></h3>
						<div class="row">
							<div class="col-md-12">
